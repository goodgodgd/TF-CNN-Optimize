...
TRAIN_DIR=/home/cideep/Work/tensorflow/checkpoints/inception-v4-cifar100
rm -r ${TRAIN_DIR}
mkdir ${TRAIN_DIR}

echo 'start retraining inception-v4 on cifar100'
...
echo -e 'finished retraining inception-v4 on cifar100\n\n\n'
