...
TRAIN_DIR=/home/cideep/Work/tensorflow/checkpoints/inc-resnet-v2-cifar10
rm -r ${TRAIN_DIR}
mkdir ${TRAIN_DIR}

echo 'start retraining inception-Resnet-v2 on cifar10'
...
echo -e 'finished retraining inception-Resnet-v2 on cifar10\n\n\n'
